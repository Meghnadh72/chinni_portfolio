...
export const siteSettings = {
  ...
  contactEmail: "hello@chinniphotography.com",
...
export const testimonials = [
  {
    ...
    clientRole: "Bride",
    quote:
      "Chinni captured every magical moment of our wedding day. The photos are so beautiful they make me cry every time I look at them. Truly an artist!",
    rating: 5,
  },
  {
    ...
    quote:
      "We've worked with many photographers, but Chinni's ability to capture the energy and emotion of our events is unmatched. A true professional.",
    rating: 5,
  },
  {
    ...
    quote:
      "Every portrait session feels effortless. Chinni has an incredible eye for light and knows exactly how to bring out the best in everyone.",
    rating: 5,
  },
  {
    ...
    clientRole: "Couple",
    quote:
      "From our engagement shoot to the wedding day, Chinni was there for every step. The photos tell our love story perfectly.",
    rating: 5,
  },
  {
    ...
    quote:
      "Chinni's editorial work is stunning. Every image has a cinematic quality that elevates any publication. Absolutely world-class.",
    rating: 5,
  },
];
